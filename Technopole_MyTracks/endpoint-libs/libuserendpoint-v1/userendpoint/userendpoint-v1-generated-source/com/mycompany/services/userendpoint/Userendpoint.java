...
package com.mycompany.services.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserendpointRequest<com.mycompany.services.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.mycompany.services.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link com.mycompany.services.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.mycompany.services.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.mycompany.services.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.mycompany.services.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.mycompany.services.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.mycompany.services.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.mycompany.services.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.mycompany.services.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.mycompany.services.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.mycompany.services.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.mycompany.services.userendpoint.model.User.class);
    }
